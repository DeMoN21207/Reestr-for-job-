<body style="background: url(/assets/Images/Find/BackCheck.jpg); background-repeat: no-repeat">
    ...
    <div style="margin-top: 5%">
        <form id="form_valid">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="period" class="form-control form-control-lg"
                           placeholder="Введите длительность проверки" id="period">
                </div>
            </div>
            <div class="row">
        ...
        <form method="post" id="import_form" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <img src="/assets/Images/Find/Excel.png" width="60" height="60" id="export"
