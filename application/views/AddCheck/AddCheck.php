    ...
    <div style="margin-top: 20%">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="name5" class="form-control form-control-lg"
                       placeholder="Введите длительность проверки" id="period" required>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <input type="button" class="btn btn-success " value="Добавить проверку" id="add_to_bd">
            </div>
