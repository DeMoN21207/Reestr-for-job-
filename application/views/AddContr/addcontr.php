...
<form id="contrForm">
    <div class="container" style="margin-top: 18%">
        ...
        <div class="row">
            ...
            <div class="col-md">
                ...
                <input type="text" class="form-control" id="name_contr" name="name_contr"
                       placeholder="Введите контролирующий орган" required>
            </div>
            <div class="col-md"></div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <button type="button" class="btn btn-primary" style="margin-top: 4pt" id="addcontr"> Добавить</button>
