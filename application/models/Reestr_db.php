...
{   //функции для работы с базой
    ...
    public function GetOrgan(){             //для получения контролирующего органа
    ...
    public function GetIDNameSMP($NameSmp){ //получение id по названию SMP
    ...
    public function param_table($name_smp,$name_org,$date_start,$date_end,$period){ //вывод таблицы по запросу пользователя
    ...
    public function update($data,$id){                      //непосредственно обновление данных
    ...
    public function import($data){                               //импорт данных
