...
class Find extends CI_Controller {
    ...
    function load_data(){                              //для построения при загрузке
        $data=$this->m->load_data();
        echo json_encode($data);
    }

    function param_table(){//для построения таблицы по заданным параметрам
    ...
    function update(){                  //обновление данных
    ...
    public function delete(){                           //удаление записи
